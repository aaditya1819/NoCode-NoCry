...
const Home = () => {
  ...
  return (
    <>
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins min-h-[80vh]">
        ...
        <p className="text-center text-base max-w-md mt-2">
          Create, customize and publish website faster than ever with NoCode NoCry.
        </p>
        ...
        <form onSubmit={onSubmitHandler} className="bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10 border border-indigo-600/70 focus-within:ring-2 ring-indigo-500 transition-all">
          ...
          <button
            disabled={loading}
            className="ml-auto flex items-center gap-2 bg-gradient-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2 disabled:opacity-70"
          >
            {!loading ? (
              'Create with AI'
            ) : (
        ...
        <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20 mx-auto mt-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
          <div className="flex items-center gap-3">
            <img className="h-7" src="https://cdn.simpleicons.org/framer/white" alt="" />
            <span className="text-2xl font-medium tracking-tight">Framer</span>
          </div>
          <div className="flex items-center gap-3">
            <img className="h-7" src="https://cdn.simpleicons.org/microsoft/white" alt="" />
            <span className="text-2xl font-medium tracking-tight font-sans">Microsoft</span>
          </div>
          <div className="flex items-center gap-3">
            <img className="h-8" src="https://cdn.simpleicons.org/intel/white" alt="" />
          </div>
          <div className="flex items-center gap-3">
            <img className="h-7" src="https://cdn.simpleicons.org/huawei/white" alt="" />
            <span className="text-[22px] font-medium tracking-tighter">HUAWEI</span>
          </div>
        </div>
      </section>
      <Footer />
